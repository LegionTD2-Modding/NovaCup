...
window.linkify = (function () {
    var
        ...
        // Restrict to main ones just to improve performance and get rid of stuff we don't care about
        TLD = "(?:com|net|org|de|gg)",
        ...
        default_options = {
            callback: function (text, href) {
                ...
                //return href ? '<a onClick="console.log(\'' + href + '\')">' + text + '<\/a>' : text;
                return href ? '<a onClick="engine.call(\'OnOpenURL\', \'' + href + '\')">' + text + '<\/a>' : text;
            },
